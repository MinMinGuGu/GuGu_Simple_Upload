...
import { PieChartOutlined, ProfileOutlined, FormOutlined, AppstoreAddOutlined } from '@ant-design/icons'
...
export default class LeftMenu extends Component {
    ...
    render() {
        return (
            <Menu theme="dark" defaultSelectedKeys={this.getSelectedItem()} defaultOpenKeys={this.getOpenKeys()} mode="inline" onClick={this.menuItemClick}>
                <Menu.Item key="1" icon={<PieChartOutlined />} path='/'>
                    概览
                </Menu.Item>
                <SubMenu key="sub1" icon={<ProfileOutlined />} title="文件管理">
                    <Menu.Item key="2" path="/file/upload">文件上传</Menu.Item>
                    <Menu.Item key="3" path='/file/list'>文件列表</Menu.Item>
                </SubMenu>
                <SubMenu key="sub2" icon={<FormOutlined />} title="系统管理">
                    <Menu.Item key="4" path='/system/user'>用户管理</Menu.Item>
                    <Menu.Item key="5" path='/system/role'>角色管理</Menu.Item>
